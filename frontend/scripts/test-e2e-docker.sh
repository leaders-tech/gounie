...
: "${E2E_ADMIN_PASSWORD:?Missing E2E_ADMIN_PASSWORD in .docker.env.}"
: "${E2E_ALLOWED_EMAIL_DOMAINS:?Missing E2E_ALLOWED_EMAIL_DOMAINS in .docker.env.}"
...
export ALLOWED_EMAIL_DOMAINS="${E2E_ALLOWED_EMAIL_DOMAINS}"
export EMAIL_MODE="log"
